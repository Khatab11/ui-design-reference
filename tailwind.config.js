...
export default {
  ...
  darkMode: 'class',
  theme: {
    // 4px base grid spacing matching DESIGN_SYSTEM.md §1 & §8 + micro units
    spacing: {
      0: '0',
      px: '1px',
      0.5: '2px',
    ...
    // Type scale matching DESIGN_SYSTEM.md §1 & §3 + Apple typography
    fontSize: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 2px 8px rgba(0,0,0,0.06), 0 12px 28px rgba(0,0,0,0.04)',
        'card-dark': '0 1px 3px rgba(0,0,0,0.4), 0 8px 24px rgba(0,0,0,0.25)',
      },
      maxWidth: {
        prose: '72ch', // Measure caps at 72 characters
      },
  ...
  plugins: [
    function ({ addVariant }) {
      addVariant('in-data-panel-open', [
        '&[data-state="open"]',
        ':where([data-state="open"]) &',
        ':where([data-panel-open]) &',
      ])
    },
  ],
}
